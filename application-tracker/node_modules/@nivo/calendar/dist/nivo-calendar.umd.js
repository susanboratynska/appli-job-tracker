(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define(['exports', 'recompose/setDisplayName', 'react', '@nivo/core', '@nivo/legends', 'prop-types', 'd3-time-format', 'recompose/pure', 'recompose/withPropsOnChange', 'recompose/defaultProps', 'recompose/compose', 'd3-scale', 'lodash.memoize', 'lodash.isdate', 'lodash.range', 'd3-time', '@nivo/tooltip'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.RecomposeSetDisplayName, global.React, global.nivo, global.nivo, global.PropTypes, global.d3, global.RecomposePure, global.RecomposeWithPropsOnChange, global.RecomposeDefaultProps, global.RecomposeCompose, global.d3, global.lodash.memoize, global.lodash.isdate, global.lodash.range, global.d3, global.nivo));
}(this, (function (exports, _setDisplayName, React, core, legends, PropTypes, d3TimeFormat, _pure, _withPropsOnChange, _defaultProps, _compose, d3Scale, memoize, isDate, range, d3Time, tooltip) { 'use strict';

    _setDisplayName = _setDisplayName && _setDisplayName.hasOwnProperty('default') ? _setDisplayName['default'] : _setDisplayName;
    var React__default = 'default' in React ? React['default'] : React;
    PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
    _pure = _pure && _pure.hasOwnProperty('default') ? _pure['default'] : _pure;
    _withPropsOnChange = _withPropsOnChange && _withPropsOnChange.hasOwnProperty('default') ? _withPropsOnChange['default'] : _withPropsOnChange;
    _defaultProps = _defaultProps && _defaultProps.hasOwnProperty('default') ? _defaultProps['default'] : _defaultProps;
    _compose = _compose && _compose.hasOwnProperty('default') ? _compose['default'] : _compose;
    ...
    var commonPropTypes = {
      ...
      legends: PropTypes.arrayOf(PropTypes.shape(_objectSpread({}, legends.LegendPropShape, {
    ...
    var commonEnhancers = [core.withTheme(), core.withDimensions(), _withPropsOnChange(['data', 'minValue', 'maxValue', 'colors', 'colorScale'], function (_ref) {
      var data = _ref.data,
    ...
    var enhance$1 = _compose(_withPropsOnChange(['data', 'onClick'], function (_ref2) {
      ...
      return {
        showTooltip: function showTooltip(event) {
          return _showTooltip(React__default.createElement(tooltip.BasicTooltip, {
            id: "".concat(data.day),
            value: data.value,
            enableChip: true,
            color: color,
    ...
    var Calendar = function Calendar(_ref) {
      ...
      return React__default.createElement(core.Container, {
        ...
        return React__default.createElement(core.SvgWrapper, {
          ...
          return React__default.createElement(CalendarDay$1, {
            key: d.date.toString(),
            data: d,
            x: d.x,
            y: d.y,
          ...
          return React__default.createElement(CalendarMonthPath$1, {
            key: m.date.toString(),
            path: m.path,
    ...
    var ResponsiveCalendar = function ResponsiveCalendar(props) {
      return React__default.createElement(core.ResponsiveWrapper, null, function (_ref) {
        var width = _ref.width,
            height = _ref.height;
        return React__default.createElement(Calendar$1, _extends$1({
          width: width,
          height: height
        }, props));
      });
    ...
    var findDayUnderCursor = function findDayUnderCursor(days, size, spacing, margin, x, y) {
      return days.find(function (day) {
        return day.value !== undefined && core.isCursorInRect(day.x + margin.left - spacing / 2, day.y + margin.top - spacing / 2, size + spacing, size + spacing, x, y);
      });
    };
    var CalendarCanvas =
    function (_Component) {
          ...
          return function (event) {
            ...
            if (currentDay !== undefined) {
              showTooltip(React__default.createElement(tooltip.BasicTooltip, {
                ...
                theme: theme,
                format: tooltipFormat,
                renderContent: typeof tooltip$1 === 'function' ? tooltip$1.bind(null, currentDay) : null
              }), event);
            } else {
              hideTooltip();
            }
      ...
      _createClass(CalendarCanvas, [{
        ...
        value: function draw(props) {
          ...
          monthLegends.forEach(function (month) {
            ...
            _this2.ctx.rotate(core.degreesToRadians(month.rotation));
          ...
          yearLegends.forEach(function (year) {
            ...
            _this2.ctx.rotate(core.degreesToRadians(year.rotation));
    ...
    var ResponsiveCalendarCanvas = function ResponsiveCalendarCanvas(props) {
      return React__default.createElement(core.ResponsiveWrapper, null, function (_ref) {
        var width = _ref.width,
            height = _ref.height;
        return React__default.createElement(CalendarCanvas$1, _extends$2({
          width: width,
          height: height
        }, props));
      });
